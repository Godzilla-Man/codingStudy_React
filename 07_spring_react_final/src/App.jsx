...
- .env(환경변수 파일)
  ...
  .env 파일 내부에는 민감한 정보가 포함되어 있을 수 있으므로, .gitignore에 작성하여 원격 저상소에 Push되지 않도록 처리한다.
...
- 로그인 기능
  필요한 변수(isLogin, loginMember)를 Login 컴포넌트에서 선언 및 변경 => HeaderLink에서 사용 불가. 컴포넌트는 당방향 구조이므로. 
  ...
  문제점
      ...
      - 자식3
      - 자식4 (State 변수 사용)
    => 자식1, 자식2, 자식3은 State 변수를 사용하지 않지만, 자식 4에서 사용하기 위해 전달해주는 코드(props에서 추출) 작성해야 함.
